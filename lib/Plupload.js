...
var Plupload = function (_React$Component) {
  ...
  _createClass(Plupload, [{
    ...
    value: function render() {
      ...
      var BButton = _react2.default.createFactory(_BrowseButton2.default);
      var UButton = _react2.default.createFactory(_UploadButton2.default);

      return _react2.default.createElement('div', { className: 'my-list', id: 'container' + this.id }, _react2.default.createElement('ul', { className: 'list-unstyled' }, list), BButton(propsSelect), UButton(propsUpload));
    }
  }]);
